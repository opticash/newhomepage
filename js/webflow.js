    ...
    window.tram = (function (e) {
      ...
      var p = (function (l, T, S) {
          ...
          function te(oe, _e) {
            ...
            function le() {}
            _e === S && ((_e = oe), (oe = Object)), (z.Bare = le);
            var fe,
              Ae = (C[l] = oe[l]),
              ut = (le[l] = z[l] = new C());
            return (
              (ut.constructor = z),
              (z.mixin = function (Fe) {
                return (le[l] = z[l] = te(z, Fe)[l]), z;
              }),
              (z.open = function (Fe) {
                if (
                  ((fe = {}),
                  O(Fe) ? (fe = Fe.call(z, ut, Ae, z, oe)) : R(Fe) && (fe = Fe),
                  R(fe))
                )
                  for (var wr in fe) T.call(fe, wr) && (ut[wr] = fe[wr]);
                return O(ut.init) || (ut.init = oe), z;
              }),
              z.open(_e)
            );
          }
        ...
        _ = {
          ...
          "ease-in": [
            ...
            function (l, T, S, R) {
              var O = (l /= R) * l,
                C = O * l;
              return T + S * (-1 * C * O + 3 * O * O + -3 * C + 2 * O);
            },
          ],
          "ease-out": [
            "ease-out",
          ...
          "ease-in-out": [
            ...
            function (l, T, S, R) {
              var O = (l /= R) * l,
                C = O * l;
              return T + S * (2 * C * O + -5 * O * O + 2 * C + 2 * O);
            },
          ],
          linear: [
            "linear",
      ...
      var G = (t.frame = (function () {
        ...
        f = p(function (l) {
              ...
              if (he == "string" && pe) {
                switch (ne) {
                  ...
                  case "redraw":
                    ...
                    break;
                  default:
                    T.call(this, ne, Ie && Ie[1]);
                }
                return C.call(this);
              }
              if (he == "function") return void ne.call(this, this);
              if (he == "object") {
                var Ge = 0;
                ut.call(
                  this,
                  ne,
                  function (Se, mm) {
                    Se.span > Ge && (Ge = Se.span), Se.stop(), Se.animate(mm);
                  },
                  function (Se) {
          ...
          function C() {
            if (
              ...
              S.call(this, ne.options, !0, ne.args);
            }
          }
          function te(ne) {
            this.timer && this.timer.destroy(),
          ...
          function oe(ne) {
            te.call(this, ne), ut.call(this, ne, wr, _m);
          }
          function _e(ne) {
              ...
              (Ze = ne[he]),
                he in ve
                  ? (Se.transform || (Se.transform = {}),
                    (Se.transform[he] = Ze))
                  : (q.test(he) && (he = r(he)),
                    he in K ? (Se[he] = Ze) : (Be || (Be = {}), (Be[he] = Ze)));
            for (he in Se) {
          ...
          function ym(ne, pe) {
            ...
            for (Ie = 0; he > Ie; Ie++) ne.apply(this.children[Ie], pe);
            return this;
          }
          (l.init = function (ne) {
            if (
              ...
              pe && !Y.test(pe) && (this.upstream = pe);
            }
            U.backface &&
              ce.hideBackface &&
              g(this.el, U.backface.css, "hidden");
          }),
            Qe("add", T),
            Qe("start", S),
            Qe("wait", R),
        ...
        m = p(f, function (l) {
          function T(S, R) {
            var O = e.data(S, D) || e.data(S, D, new f.Bare());
            return O.el || O.init(S), R ? O.start(R) : O;
          }
          l.init = function (S, R) {
            var O = e(S);
        ...
        I = p(function (l) {
          ...
          function R(C) {
            ...
            return (te ? o(te[1], te[2], te[3]) : C).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
          var O = { duration: 500, ease: "ease", delay: 0 };
          (l.init = function (C, te, oe, _e) {
            ...
            oe[2] && (z = oe[2]),
              ...
              (this.ease = S(te[2], this.ease, O.ease)),
        ...
        Z = p(I, function (l, T) {
          ...
          (l.init = function () {
            ...
            (l.transition = function (R) {
              ...
              var C,
                te = {};
              for (C in this.current) te[C] = C in O ? O[C] : this.current[C];
            ...
            (l.values = function (R) {
              var O,
                C = {};
              return (
                S.call(this, R, function (te, oe, _e) {
                  (C[te] = oe),
        ...
        ee = p(function (l) {
          ...
          (l.init = function (z) {
            ...
            var fe = z.from,
              Ae = z.to;
            fe === void 0 && (fe = te.from),
              Ae === void 0 && (Ae = te.to),
              (this.unit = z.unit || ""),
              typeof fe == "number" && typeof Ae == "number"
                ? ((this.begin = fe), (this.change = Ae - fe))
                : this.format(Ae, fe),
            ...
            (l.render = function (z) {
              ...
              if (fe < this.duration) {
                var Ae = this.ease(fe, 0, 1, this.duration);
                return (
                  (le = this.startRGB
            ...
            (l.format = function (z, le) {
              ...
              if (!this.unit) {
                var fe = le.replace(P, ""),
                  Ae = z.replace(P, "");
                fe !== Ae && s("tween", le, z), (this.unit = fe);
              }
              (le = parseFloat(le)),
                (z = parseFloat(z)),
          ...
          (l.init = function (S) {
            ...
            (l.render = function (S) {
              ...
              for (R = C; R--; )
                (O = this.tweens[R]),
                  O.context &&
                    (O.render(S), (this.current[O.name] = O.value), (te = !0));
              return te
      ...
      (t.fallback = function (l) {
        ...
        (t.delay = function (l, T, S) {
          return new de({ complete: T, duration: l, context: S });
        }),
      ...
      var g = e.style,
        ...
        K = {
          color: [h, V],
          background: [h, V, "background-color"],
          "outline-color": [h, V],
          "border-color": [h, V],
          "border-top-color": [h, V],
          "border-right-color": [h, V],
          "border-bottom-color": [h, V],
          "border-left-color": [h, V],
          "border-width": [I, X],
    ...
    Ss.exports = (function () {
      ...
      (e.contains = e.include =
        ...
        (e.debounce = function (v, M, N) {
          var U,
            ...
            f = function () {
              ...
              m < M
                ? (U = setTimeout(f, M - m))
                : ((U = null), N || ((H = v.apply(re, $)), (re = $ = null)));
            };
          return function () {
            (re = this), ($ = arguments), (G = e.now());
            var m = N && !U;
            return (
              U || (U = setTimeout(f, M)),
              m && ((H = v.apply(re, $)), (re = $ = null)),
              H
            );
          };
        }),
        ...
        (e.keys = function (v) {
          ...
          if (V) return V(v);
          var M = [];
          for (var N in v) e.has(v, N) && M.push(N);
          return M;
        }),
        (e.has = function (v, M) {
          return d.call(v, M);
      ...
      var Q = /(.)^/,
        ...
        x = /^\s*(\w|\$)+\s*$/;
      return (
        (e.template = function (v, M, N) {
          !M && N && (M = N), (M = e.defaults({}, M, e.templateSettings));
          var U = RegExp(
              [
                (M.escape || Q).source,
                (M.interpolate || Q).source,
                (M.evaluate || Q).source,
              ].join("|") + "|$",
              "g"
            ),
            $ = 0,
            re = "__p+='";
          v.replace(U, function (m, I, h, j, Z) {
            return (
              (re += v.slice($, Z).replace(ie, W)),
              ($ = Z + m.length),
              I
                ? (re +=
                    `'+
...
`;
          var H;
          try {
            H = new Function(M.variable || "obj", "_", re);
          } catch (m) {
            throw ((m.source = re), m);
          }
          var f = function (m) {
...
` +
  ...
  var Ke = u((XW, Ms) => {
    ...
    var dn = navigator.userAgent.toLowerCase(),
      ...
      wm = (ge.env.ios = /(ipod|iphone|ipad)/.test(dn));
    ge.env.safari = /safari/.test(dn) && !Sm && !wm;
    var Wi;
    Ps &&
      Om.on("touchstart mousedown", function (e) {
        Wi = e.target;
      });
    ge.validClick = Ps
      ? function (e) {
    ...
    ge.ready = function () {
      (pn = !0), ki ? Cm() : Je.each(Qt, Rs), Je.each(Bi, Rs), ge.resize.up();
    };
    function Rs(e) {
      ct(e) && e();
    }
    ...
    function Ls() {
      Ft && (Ft.reject(), et.off("load", Ft.resolve)),
        (Ft = new bt.Deferred()),
        et.on("load", Ft.resolve);
    }
        ...
        function e(r) {
          ...
          function c(w) {
            var V = w.type,
              X = w.tagName;
            return !!(
              (X === "INPUT" && a[V] && !w.readOnly) ||
              (X === "TEXTAREA" && !w.readOnly) ||
              w.isContentEditable
            );
          }
          function d(w) {
  ...
  var js = u((BW, Hs) => {
    ...
    var ji = window.jQuery,
      ...
      hn = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), ji(t).triggerHandler(lt.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), ji(t).triggerHandler(lt.types.OUTRO));
        },
      };
    lt.triggers = {};
  ...
  var Rr = u((kW, Ys) => {
    ...
    gn.triggers = {};
    gn.types = { INTRO: "w-ix-intro" + zs, OUTRO: "w-ix-outro" + zs };
    xm.extend(gn.triggers, Pm);
    Ys.exports = gn;
  });
  var $s = u((HW, yt) => {
    function zi(e) {
  ...
  var mu = u((uB, yu) => {
    var Jm = rt();
    yu.exports = Jm({}.isPrototypeOf);
  });
  var Tu = u((cB, Iu) => {
    var eI = qr();
    Iu.exports = eI("navigator", "userAgent") || "";
  });
  var Cu = u((lB, Ru) => {
    var wu = me(),
      to = Tu(),
      Ou = wu.process,
      bu = wu.Deno,
      Au = (Ou && Ou.versions) || (bu && bu.version),
      Su = Au && Au.v8,
      nt,
      yn;
    Su &&
      ((nt = Su.split(".")),
      (yn = nt[0] > 0 && nt[0] < 4 ? 1 : +(nt[0] + nt[1])));
    !yn &&
      to &&
      ((nt = to.match(/Edge\/(\d+)/)),
      (!nt || nt[1] >= 74) &&
        ((nt = to.match(/Chrome\/(\d+)/)), nt && (yn = +nt[1])));
    Ru.exports = yn;
  });
  var ro = u((fB, xu) => {
    var Nu = Cu(),
  ...
  var co = u((bB, Ju) => {
    ...
    Ju.exports = function (e) {
      return "Symbol(" + (e === void 0 ? "" : e) + ")_" + PI(++NI + xI, 36);
    };
  });
  var lo = u((AB, ic) => {
    var qI = me(),
      ...
      Ut = qI.Symbol,
      rc = Ut && Ut.for,
      DI = nc ? Ut : (Ut && Ut.withoutSetter) || MI;
    ic.exports = function (e) {
      if (!ec(er, e) || !(tc || typeof er[e] == "string")) {
        var t = "Symbol." + e;
        tc && ec(Ut, e)
          ? (er[e] = Ut[e])
          : nc && rc
  ...
  var uc = u((SB, sc) => {
    ...
    sc.exports = function (e, t) {
      ...
      if (r) {
        if (
          (t === void 0 && (t = "default"), (n = GI(r, e, t)), !oc(n) || ac(n))
        )
          return n;
  ...
  var bc = u((MB, Oc) => {
    var yT = me(),
      ...
      IT = _o(),
      Tc = yT.WeakMap;
    Oc.exports = mT(Tc) && /native code/.test(IT(Tc));
  });
  var yo = u((DB, Sc) => {
    var TT = uo(),
      OT = co(),
  ...
  var qc = u((GB, Pc) => {
    ...
    bT || To.state
      ? ((St = To.state || (To.state = new CT())),
        ...
        (Nc = mo(St.set)),
        (bn = function (e, t) {
          if (Oo(St, e)) throw new bo(Rc);
          return (t.facade = e), Nc(St, e, t), t;
        }),
        (Dr = function (e) {
          return Cc(St, e) || {};
        }),
      ...
      : ((Vt = wT("state")),
        (RT[Vt] = !0),
        (bn = function (e, t) {
          if (Io(e, Vt)) throw new bo(Rc);
          return (t.facade = e), ST(e, Vt, t), t;
        }),
        (Dr = function (e) {
          return Io(e, Vt) ? e[Vt] : {};
        }),
    ...
    var St, Cc, Oo, Nc, Vt;
    Pc.exports = { set: bn, get: Dr, has: An, enforce: NT, getterFor: xT };
  });
  var Dc = u((XB, Mc) => {
    var Ao = Xt(),
      PT = At(),
      Lc = Function.prototype,
      qT = Ao && Object.getOwnPropertyDescriptor,
      So = PT(Lc, "name"),
      LT = So && function () {}.name === "something",
      MT = So && (!Ao || (Ao && qT(Lc, "name").configurable));
    Mc.exports = { EXISTS: So, PROPER: LT, CONFIGURABLE: MT };
  });
  var Vc = u((UB, Uc) => {
    var DT = me(),
      Fc = ft(),
    ...
    (Uc.exports = function (e, t, r, n) {
      ...
      if (
        (Fc(r) &&
          ...
          (!FT(r, "name") || (UT && r.name !== s)) && Gc(r, "name", s),
          (c = WT(r)),
      ...
      return (Fc(this) && VT(this).source) || XT(this);
    });
  });
  var wo = u((VB, Wc) => {
    var kT = Math.ceil,
    ...
    ll.exports = function (e, t) {
      ...
      if (
        ...
        for (s in t) {
          if (
            ((d = t[s]),
            e.noTargetGet ? ((E = AO(a, s)), (c = E && E.value)) : (c = a[s]),
  ...
  var hl = u((tk, vl) => {
    ...
    vl.exports = qO
      ...
      : function (t, r) {
          MO(t);
          for (var n = DO(r), o = FO(r), i = o.length, a = 0, s; i > a; )
            LO.f(t, (s = o[a++]), n[s]);
          return t;
        };
  });
        ...
        Rn =
          typeof document < "u"
            ? document.domain && wn
              ...
              : HO()
            : Il(wn);
        for (var e = _l.length; e--; ) delete Rn[qo][_l[e]];
        return Rn();
      };
    VO[Tl] = !0;
    bl.exports =
      ...
      function (t, r) {
        ...
        return (
          t !== null
            ? ((Po[qo] = XO(t)), (n = new Po()), (Po[qo] = null), (n[Tl] = t))
            : (n = Rn()),
          r === void 0 ? n : UO(n, r)
        );
      };
  ...
  var Bl = u((vk, Wl) => {
    var Ul = tr(),
      Vl = Object.prototype,
      cb = Vl.hasOwnProperty,
      lb = Vl.toString,
      Gr = Ul ? Ul.toStringTag : void 0;
    function fb(e) {
      var t = cb.call(e, Gr),
        r = e[Gr];
      try {
  ...
  var Uo = u((mk, Jl) => {
    var bb = wt(),
      ...
      xb = Zl.call(Object);
    function Pb(e) {
      if (!Sb(e) || bb(e) != wb) return !1;
      var t = Ab(e);
      if (t === null) return !0;
      var r = Nb.call(t, "constructor") && t.constructor;
      return typeof r == "function" && r instanceof r && Zl.call(r) == xb;
    }
    Jl.exports = Pb;
  });
  var ef = u((Vo) => {
  ...
  var ko = u((Xr) => {
    ...
    var nf = (Xr.ActionTypes = { INIT: "@@redux/INIT" });
    function af(e, t, r) {
      var n;
      if (
      ...
      function _(b) {
        ...
        for (var D = (a = s), P = 0; P < D.length; P++) D[P]();
        return b;
      }
      function y(b) {
        if (typeof b != "function")
      ...
      return (
        _({ type: nf.INIT }),
        (n = { dispatch: _, subscribe: p, getState: E, replaceReducer: y }),
        (n[rf.default] = A),
        n
      );
    }
  ...
  var Zo = u((ze) => {
    ...
    ze.createStore = tA.default;
    ze.combineReducers = nA.default;
    ze.bindActionCreators = oA.default;
    ze.applyMiddleware = sA.default;
    ze.compose = cA.default;
  });
  var pf = u((xe) => {
    "use strict";
    ...
    xe.EventTypeConsts = fA;
    var dA = { ELEMENT: "ELEMENT", CLASS: "CLASS", PAGE: "PAGE" };
    xe.EventAppliesTo = dA;
    var pA = { ELEMENT: "ELEMENT", VIEWPORT: "VIEWPORT" };
    xe.EventBasedOn = pA;
    var vA = { X_AXIS: "X_AXIS", Y_AXIS: "Y_AXIS" };
    xe.EventContinuousMouseAxes = vA;
    var hA = {
      CHILDREN: "CHILDREN",
      SIBLINGS: "SIBLINGS",
      IMMEDIATE_CHILDREN: "IMMEDIATE_CHILDREN",
    };
    xe.EventLimitAffectedElements = hA;
    var gA = {
    ...
    xe.QuickEffectDirectionConsts = EA;
  });
  var Jo = u((ir) => {
    "use strict";
    ...
    ir.ActionTypeConsts = _A;
    var yA = {
      ELEMENT: "ELEMENT",
      ELEMENT_CLASS: "ELEMENT_CLASS",
      TRIGGER_ELEMENT: "TRIGGER_ELEMENT",
    };
    ir.ActionAppliesTo = yA;
  });
  var vf = u((Cn) => {
    "use strict";
  ...
  var gf = u((se) => {
    ...
    se.IX2_VIEWPORT_WIDTH_CHANGED =
      ...
      se.IX2_ACTION_LIST_PLAYBACK_CHANGED =
        void 0;
    var NA = "IX2_RAW_DATA_IMPORTED";
    se.IX2_RAW_DATA_IMPORTED = NA;
    var xA = "IX2_SESSION_INITIALIZED";
    se.IX2_SESSION_INITIALIZED = xA;
    var PA = "IX2_SESSION_STARTED";
    se.IX2_SESSION_STARTED = PA;
    var qA = "IX2_SESSION_STOPPED";
    se.IX2_SESSION_STOPPED = qA;
    var LA = "IX2_PREVIEW_REQUESTED";
    se.IX2_PREVIEW_REQUESTED = LA;
    var MA = "IX2_PLAYBACK_REQUESTED";
    se.IX2_PLAYBACK_REQUESTED = MA;
    var DA = "IX2_STOP_REQUESTED";
    se.IX2_STOP_REQUESTED = DA;
    var FA = "IX2_CLEAR_REQUESTED";
    se.IX2_CLEAR_REQUESTED = FA;
    var GA = "IX2_EVENT_LISTENER_ADDED";
    se.IX2_EVENT_LISTENER_ADDED = GA;
    var XA = "IX2_EVENT_STATE_CHANGED";
    se.IX2_EVENT_STATE_CHANGED = XA;
    var UA = "IX2_ANIMATION_FRAME_CHANGED";
    se.IX2_ANIMATION_FRAME_CHANGED = UA;
    var VA = "IX2_PARAMETER_CHANGED";
    se.IX2_PARAMETER_CHANGED = VA;
    var WA = "IX2_INSTANCE_ADDED";
    se.IX2_INSTANCE_ADDED = WA;
    var BA = "IX2_INSTANCE_STARTED";
    se.IX2_INSTANCE_STARTED = BA;
    var kA = "IX2_INSTANCE_REMOVED";
    se.IX2_INSTANCE_REMOVED = kA;
    var HA = "IX2_ELEMENT_STATE_CHANGED";
    se.IX2_ELEMENT_STATE_CHANGED = HA;
    var jA = "IX2_ACTION_LIST_PLAYBACK_CHANGED";
    se.IX2_ACTION_LIST_PLAYBACK_CHANGED = jA;
    var KA = "IX2_VIEWPORT_WIDTH_CHANGED";
    se.IX2_VIEWPORT_WIDTH_CHANGED = KA;
    var zA = "IX2_MEDIA_QUERIES_DEFINED";
    se.IX2_MEDIA_QUERIES_DEFINED = zA;
    var YA = "IX2_TEST_FRAME_RENDERED";
    se.IX2_TEST_FRAME_RENDERED = YA;
  });
  var Ef = u((L) => {
    "use strict";
    ...
    L.FONT_VARIATION_SETTINGS = S0;
    var w0 = "width";
    L.WIDTH = w0;
    var R0 = "height";
    L.HEIGHT = R0;
    var C0 = "backgroundColor";
    L.BACKGROUND_COLOR = C0;
    var N0 = "background";
    L.BACKGROUND = N0;
    var x0 = "borderColor";
    L.BORDER_COLOR = x0;
    ...
    L.AUTO = D0;
    var F0 = ",";
    L.COMMA_DELIMITER = F0;
    var G0 = ":";
    L.COLON_DELIMITER = G0;
    var X0 = "|";
    L.BAR_DELIMITER = X0;
    var U0 = "CHILDREN";
    L.CHILDREN = U0;
    var V0 = "IMMEDIATE_CHILDREN";
    L.IMMEDIATE_CHILDREN = V0;
    var W0 = "SIBLINGS";
    L.SIBLINGS = W0;
    var B0 = "PARENT";
    L.PARENT = B0;
    ...
    L.ABSTRACT_NODE = K0;
    var z0 = "RENDER_TRANSFORM";
    L.RENDER_TRANSFORM = z0;
    var Y0 = "RENDER_GENERAL";
    L.RENDER_GENERAL = Y0;
    var $0 = "RENDER_STYLE";
    L.RENDER_STYLE = $0;
    var Q0 = "RENDER_PLUGIN";
    L.RENDER_PLUGIN = Q0;
  });
  var ke = u((we) => {
    "use strict";
    ...
    var Z0 = _f(gf());
    we.IX2EngineActionTypes = Z0;
    var J0 = _f(Ef());
    we.IX2EngineConstants = J0;
  });
  var yf = u((Pn) => {
    "use strict";
  ...
  var ar = u((Te) => {
    ...
    function Lf(e, t, r, n, o, i, a) {
      ...
      return (
        E.length
          ? (c = He.call.apply(He, [null, !1, !1, s, r, n, o, i, a].concat(E)))
  ...
  var op = u((NH, ip) => {
    ...
    Bn.prototype.add = Bn.prototype.push = qR;
    Bn.prototype.has = LR;
    ip.exports = Bn;
  });
  var sp = u((xH, ap) => {
  ...
  var la = u((qH, lp) => {
    ...
    function WR(e, t, r, n, o, i) {
      ...
      var p = -1,
        _ = !0,
        y = r & VR ? new FR() : void 0;
      for (i.set(e, t), i.set(t, e); ++p < s; ) {
        var A = e[p],
          b = t[p];
        if (n) var D = a ? n(b, A, p, t, e, i) : n(A, b, p, e, t, i);
        if (D !== void 0) {
          if (D) continue;
          _ = !1;
          break;
        ...
        if (y) {
          if (
            !GR(t, function (P, q) {
              if (!XR(y, q) && (A === P || o(A, P, r, n, i))) return y.push(q);
            })
          ) {
            _ = !1;
            break;
  ...
  var Ip = u((FH, mp) => {
    var Ep = tr(),
      ...
      cC = "[object DataView]",
      yp = Ep ? Ep.prototype : void 0,
      fa = yp ? yp.valueOf : void 0;
  ...
  var Hn = u((Hr, fr) => {
    var qC = it(),
      ...
      Xp = Vp && typeof fr == "object" && fr && !fr.nodeType && fr,
      MC = Xp && Xp.exports === Vp,
      Up = MC ? qC.Buffer : void 0,
      DC = Up ? Up.isBuffer : void 0,
      FC = DC || LC;
    fr.exports = FC;
  });
  var jn = u((zH, Wp) => {
  ...
  var Yp = u((jr, dr) => {
    var _N = Fo(),
      ...
      Kr = zp && typeof dr == "object" && dr && !dr.nodeType && dr,
      yN = Kr && Kr.exports === zp,
      ha = yN && _N.process,
      mN = (function () {
        try {
  ...
  var lv = u((a5, cv) => {
    ...
    function rx(e, t, r, n, o, i) {
      ...
      for (var p = c; p--; ) {
        var _ = s[p];
        if (!(a ? _ in t : tx.call(t, _))) return !1;
      }
      var y = i.get(e),
        A = i.get(t);
      ...
      for (var D = a; ++p < c; ) {
        ...
        var P = e[_],
          q = t[_];
        if (n) var w = a ? n(q, P, _, t, e, i) : n(P, q, _, e, t, i);
        if (!(w === void 0 ? P === q || o(P, q, r, n, i) : w)) {
          b = !1;
          break;
        }
        D || (D = _ == "constructor");
  ...
  var Qn = u((f5, bv) => {
    var _a = dv(),
      ...
      mx = pr(Ta),
      Bt = Ov;
    ((_a && Bt(new _a(new ArrayBuffer(1))) != Tv) ||
      (ya && Bt(new ya()) != _v) ||
      (ma && Bt(ma.resolve()) != yv) ||
      (Ia && Bt(new Ia()) != mv) ||
      (Ta && Bt(new Ta()) != Iv)) &&
  ...
  var Pv = u((d5, xv) => {
    ...
    function wx(e, t, r, n, o, i) {
      ...
      if (!(r & Ax)) {
        var y = E && Nv.call(e, "__wrapped__"),
          A = p && Nv.call(t, "__wrapped__");
        if (y || A) {
          var b = y ? e.value() : e,
            D = A ? t.value() : t;
          return i || (i = new Oa()), o(b, D, r, n, i);
        }
      }
    ...
    function qx(e, t, r, n) {
      ...
      for (; ++o < i; ) {
        ...
        if (a && s[2]) {
          ...
          var p = new Cx();
          if (n) var _ = n(d, E, c, e, t, p);
          if (!(_ === void 0 ? Nx(E, d, xx | Px, n, p) : _)) return !1;
        }
      }
      return !0;
    }
  ...
  var Jn = u((m5, Hv) => {
    ...
    function Zx(e, t) {
      ...
      return r == "number" ||
        ...
        Yx(e)
        ? !0
        : Qx.test(e) || !$x.test(e) || (t != null && e in Object(t));
    }
    Hv.exports = Zx;
  });
  var zv = u((I5, Kv) => {
    ...
    function wa(e, t) {
      ...
      return (r.cache = new (wa.Cache || jv)()), r;
    }
    wa.Cache = jv;
    Kv.exports = wa;
  });
  ...
  var oh = u((A5, ih) => {
    ...
    function nh(e) {
      ...
      if (cP(e)) return uP(e, nh) + "";
      if (lP(e)) return rh ? rh.call(e) : "";
      var t = e + "";
  ...
  var $r = u((w5, uh) => {
    var vP = Pe(),
      ...
      EP = sh();
    function _P(e, t) {
      return vP(e) ? e : hP(e, t) ? [e] : gP(EP(e));
    }
    uh.exports = _P;
  });
  var vr = u((R5, ch) => {
  ...
  var yh = u((L5, _h) => {
    ...
    function KP(e, t) {
      return VP(e) && WP(t)
        ...
        : function (r) {
            var n = XP(r, e);
            return n === void 0 && n === t ? UP(r, e) : GP(t, n, HP | jP);
          };
    }
    _h.exports = KP;
  });
  ...
  var ni = u((k5, Mh) => {
    ...
    function Aq(e) {
      ...
      e = yq(e);
      var r = Tq.test(e);
      return r || Oq.test(e) ? bq(e.slice(2), r ? 2 : 8) : Iq.test(e) ? Lh : +e;
    }
    Mh.exports = Aq;
  });
  var Gh = u((H5, Fh) => {
  ...
  var Vh = u((K5, Uh) => {
    ...
    function Mq(e, t, r) {
      ...
      if (!n) return -1;
      var o = r == null ? 0 : qq(r);
      return o < 0 && (o = Lq(n + o, 0)), xq(e, Pq(t, 3), o);
    }
    Uh.exports = Mq;
  });
  var qa = u((z5, Wh) => {
  ...
  var oi = u((Xe) => {
    ...
    var Bh = Hh.split("transform")[0],
      Bq = Bh ? Bh + "TransformStyle" : "transformStyle";
    Xe.TRANSFORM_STYLE_PREFIXED = Bq;
  });
  var La = u(($5, $h) => {
    var kq = 4,
      Hq = 0.001,
    ...
    function si(e, t, r) {
      return ((jh(t, r) * e + Kh(t, r)) * e + zh(t)) * e;
    }
    function Yh(e, t, r) {
      return 3 * jh(t, r) * e * e + 2 * Kh(t, r) * e + zh(t);
    }
    ...
    $h.exports = function (t, r, n, o) {
      ...
      var i = zq ? new Float32Array(Qr) : new Array(Qr);
      if (t !== r || n !== o)
        for (var a = 0; a < Qr; ++a) i[a] = si(a * ai, t, n);
      function s(c) {
        for (var d = 0, E = 1, p = Qr - 1; E !== p && i[E] <= c; ++E) d += ai;
        --E;
        var _ = (c - i[E]) / (i[E + 1] - i[E]),
          y = d + _ * ai,
          A = Yh(y, t, n);
        return A >= Hq ? $q(c, y, t, n) : A === 0 ? y : Yq(c, d, d + ai, t, n);
      }
      return function (d) {
        return t === r && n === o
          ? d
  ...
  var Ma = u((ae) => {
    ...
    var ui = Qq(La()),
      Tt = 1.70158,
      Zq = (0, ui.default)(0.25, 0.1, 0.25, 1);
    ae.ease = Zq;
    var Jq = (0, ui.default)(0.42, 0, 1, 1);
    ae.easeIn = Jq;
  ...
  var tg = u((hr) => {
    ...
    hr.createElementState = eg;
    hr.ixElements = void 0;
    hr.mergeActionState = Ga;
    var ci = ar(),
      Jh = ke(),
      {
        HTML_ELEMENT: J5,
        ...
        switch (t.type) {
          ...
          case $L: {
            let {
              ...
              c = e;
            return (
              (0, ci.getIn)(c, [r, n]) !== n && (c = eg(c, n, a, r, i)),
              Ga(c, r, s, o, i)
            );
          }
          case QL: {
    ...
    function eg(e, t, r, n, o) {
      let i =
        r === UL ? (0, ci.getIn)(o, ["config", "target", "objectId"]) : null;
  ...
  var ig = u((Le) => {
    ...
    var cM = (e) => document.querySelector(`[data-w-id="${e}"]`),
      ...
      dM = (e, t) => e.value[t];
    Le.getPluginConfig = dM;
    var pM = () => null;
    Le.getPluginDuration = pM;
    var ng = Object.freeze({
      ...
      vM = (e, t) => {
        ...
        if (e) {
          let i = Object.keys(e),
            a = fM(n, i);
          return a.length ? a.reduce((c, d) => ((c[d] = ng[d]), c), e) : e;
        }
        return n.reduce((i, a) => ((i[a] = ng[a]), i), {});
      };
    Le.getPluginOrigin = vM;
    var hM = (e) => e.value;
    Le.getPluginDestination = hM;
    var gM = (e, t) => {
      var r, n;
      let o =
        t == null ||
  ...
  var ag = u((Ce) => {
    ...
    function og(e) {
      ...
      if (i.startsWith("#")) {
        ...
        o = parseFloat(a[3]);
        let E = (1 - Math.abs(2 * d - 1)) * c,
          p = E * (1 - Math.abs(((s / 60) % 2) - 1)),
          _ = d - E / 2,
          y,
          A,
          b;
    ...
    Ce.getPluginConfig = yM;
    var mM = () => null;
    Ce.getPluginDuration = mM;
    var IM = (e, t) => {
      if (e) return e;
      let r = t.config.value,
      ...
      if (r.red != null && r.green != null && r.blue != null) return og(o);
    };
    Ce.getPluginOrigin = IM;
    var TM = (e) => e.value;
    Ce.getPluginDestination = TM;
    var OM = () => null;
    ...
    var bM = (e, t, r) => {
      let n = r.config.target.objectId,
        ...
        { PLUGIN_VARIABLE: i } = t,
        { size: a, red: s, green: c, blue: d, alpha: E } = i,
        p;
      a != null && (p = a + o),
        s != null &&
          d != null &&
  ...
  var sg = u((li) => {
    ...
    var Xa = SM(or()),
      ...
      CM = Va(ag()),
      NM = new Map([
        [Ua.ActionTypeConsts.PLUGIN_LOTTIE, (0, Xa.default)({}, wM)],
        [Ua.ActionTypeConsts.PLUGIN_SPLINE, (0, Xa.default)({}, RM)],
        [Ua.ActionTypeConsts.PLUGIN_VARIABLE, (0, Xa.default)({}, CM)],
      ]);
  ...
  var Wa = u((Ne) => {
    ...
    var xM = oi(),
      ug = sg();
    function PM(e) {
      return ug.pluginMethodMap.has(e);
    }
    var kt = (e) => (t) => {
        if (!xM.IS_BROWSER_ENV) return () => null;
        let r = ug.pluginMethodMap.get(t);
        if (!r) throw new Error(`IX2 no plugin configured for: ${t}`);
        let n = r[e];
        if (!n) throw new Error(`IX2 invalid plugin method: ${e}`);
        return n;
      },
      qM = kt("getPluginConfig");
    Ne.getPluginConfig = qM;
    var LM = kt("getPluginOrigin");
    Ne.getPluginOrigin = LM;
    var MM = kt("getPluginDuration");
    Ne.getPluginDuration = MM;
    var DM = kt("getPluginDestination");
    Ne.getPluginDestination = DM;
    var FM = kt("createPluginInstance");
    Ne.createPluginInstance = FM;
    var GM = kt("renderPlugin");
    Ne.renderPlugin = GM;
    var XM = kt("clearPlugin");
    Ne.clearPlugin = XM;
  });
  var lg = u((sj, cg) => {
    function UM(e, t) {
  ...
  var Sg = u((gj, Ag) => {
    ...
    function fD(e, t, r) {
      ...
      return (
        r !== void 0 &&
          ((o = uD(r)), (o = r < 0 ? cD(n + o, 0) : lD(o, n - 1))),
        aD(e, sD(t, 3), o, !0)
      );
    }
    Ag.exports = fD;
  ...
  var Ng = u((fi) => {
    ...
    function gD(e, t) {
      ...
      for (let o = 0; o < r.length; o++)
        if (!hD.call(t, r[o]) || !Cg(e[r[o]], t[r[o]])) return !1;
      return !0;
    }
    var ED = gD;
    fi.default = ED;
  ...
  var Yg = u((Ee) => {
    ...
    var Nt = hi(lg()),
      ...
      Bg = (e) => e.trim(),
      $a = Object.freeze({ [Ir]: Xg, [Tr]: CD, [Or]: ND }),
      kg = Object.freeze({
        [Ue.TRANSFORM_PREFIXED]: mD,
        [Xg]: yD,
        [pi]: pi,
        [Jr]: Jr,
        [vt]: vt,
    ...
    function UD({ events: e, actionLists: t, site: r } = {}) {
      let n = (0, Ka.default)(
          e,
          (a, s) => {
            let { eventTypeId: c } = s;
    ...
    function Qa({
      ...
      if (w) return [di.has(w) ? di.get(w) : di.set(w, {}).get(w)];
      if (F === Ht.EventAppliesTo.PAGE) {
        let N = d(q);
        return N ? [N] : [];
      }
      let Y =
      ...
      if (
        (ie
          ? ((W = Y.limitAffectedElements), (x = M), (v = E(Y)))
          : (x = v = E({ id: q, selector: V, selectorGuids: X })),
        t && B)
      ) {
        let N = r && (v || B === !0) ? [r] : p(M);
        if (v) {
          if (B === PD) return p(v).filter((U) => N.some(($) => b(U, $)));
          if (B === Pg) return p(v).filter((U) => N.some(($) => b($, U)));
          if (B === qg) return p(v).filter((U) => N.some(($) => D($, U)));
        }
        return N;
      }
      return x == null || v == null
        ? []
        : Ue.IS_BROWSER_ENV && n
        ? p(v).filter((N) => n.contains(N))
        : W === Pg
        ? p(x, v)
        : W === xD
        ? _(p(x)).filter(A(v))
    ...
    var Mg = /px/,
      ...
      HD = (e, t) =>
        t.reduce(
          (r, n) => (
            r[n.type] == null &&
              (r[n.type] = e1[n.type] || n.defaultValue || 0),
            r
          ),
          e || {}
        );
        ...
        case mr: {
          ...
          return (
            n.config.widthUnit === xt
              ? (d = Mg.test(s) ? parseFloat(s) : parseFloat(r.width))
              : (d = (0, Nt.default)(parseFloat(s), parseFloat(r.width))),
            n.config.heightUnit === xt
              ? (E = Mg.test(c) ? parseFloat(c) : parseFloat(r.height))
    ...
    function $D({ element: e, actionItem: t, elementApi: r }) {
      ...
      switch (t.actionTypeId) {
        ...
        case mr: {
          ...
          if (!Ue.IS_BROWSER_ENV) return { widthValue: c, heightValue: d };
          if (a === xt) {
            let E = n(e, vt);
            o(e, vt, ""), (c = i(e, "offsetWidth")), o(e, vt, E);
          }
          if (s === xt) {
            let E = n(e, ht);
            o(e, ht, ""), (d = i(e, "offsetHeight")), o(e, ht, E);
          }
    ...
    function n1(e, t, r, n, o) {
      let i = r1
          .map((s) => {
            ...
            switch (s) {
              case Er:
                return `${ID}(${d}${_}, ${E}${y}, ${p}${A})`;
              case _r:
                return `${TD}(${d}${_}, ${E}${y}, ${p}${A})`;
              case yr:
                return `${OD}(${d}${_}) ${bD}(${E}${y}) ${AD}(${p}${A})`;
              case rn:
                return `${SD}(${d}${_}, ${E}${y})`;
              default:
                return "";
          ...
          .join(" "),
        { setStyle: a } = o;
      jt(e, Ue.TRANSFORM_PREFIXED, o),
        a(e, Ue.TRANSFORM_PREFIXED, i),
        a1(n, r) && a(e, Ue.TRANSFORM_STYLE_PREFIXED, wD);
    }
    function i1(e, t, r, n) {
    ...
    function d1(e, t, r, n, o, i) {
      ...
      switch (n.actionTypeId) {
        case mr: {
          ...
          d !== void 0 &&
            (s === xt && (s = "px"), jt(e, vt, i), a(e, vt, d + s)),
            E !== void 0 &&
              (c === xt && (c = "px"), jt(e, ht, i), a(e, ht, E + c));
          break;
        }
        case nn: {
          i1(e, r, n.config, i);
    ...
    function p1(e, t, r) {
      ...
      switch (t.actionTypeId) {
        case gi: {
          ...
          o === RD && Ue.IS_BROWSER_ENV
            ? n(e, vi, Ue.FLEX_PREFIXED)
            : n(e, vi, o);
          return;
        }
      }
    ...
    function v1({ store: e, elementApi: t }) {
      ...
      Object.keys(n).forEach((i) => {
        let a = n[i],
          ...
          { actionListId: c } = s,
          d = o[c];
        d && Dg({ actionList: d, event: a, elementApi: t });
      }),
        Object.keys(o).forEach((i) => {
          Dg({ actionList: o[i], elementApi: t });
        });
    }
      ...
      n &&
        ...
        o &&
          o.forEach((i) => {
            ...
            a.forEach((s) => {
              Fg({ actionGroup: s, event: t, elementApi: r });
            });
          });
    }
    function Fg({ actionGroup: e, event: t, elementApi: r }) {
      ...
      n.forEach((o) => {
        ...
        (0, gt.isPluginType)(i)
          ...
          : (s = Kg({ effect: g1, actionTypeId: i, elementApi: r })),
    ...
    function E1(e, t) {
      ...
      return (
        r.forEach((c, d) => {
          ...
          let { actionItems: E } = c,
            p = E[zg(E)],
            { config: _, actionTypeId: y } = p;
          o.id === p.id && (s = a + i);
          let A = Hg(y) === za ? 0 : _.duration;
          a += _.delay + A;
        }),
    ...
    function _1({ actionList: e, actionItemId: t, rawData: r }) {
      let { actionItemGroups: n, continuousParameterGroups: o } = e,
        i = [],
        a = (s) => (
          i.push((0, xg.mergeIn)(s, ["config"], { delay: 0, duration: 0 })),
          s.id === t
        );
      return (
  ...
  var Kt = u((Ve) => {
    ...
    Ve.IX2VanillaUtils =
      ...
      Ve.IX2BrowserSupport =
        void 0;
    var b1 = br(oi());
    Ve.IX2BrowserSupport = b1;
    var A1 = br(Ma());
    Ve.IX2Easings = A1;
    var S1 = br(Fa());
    Ve.IX2EasingUtils = S1;
    var w1 = br(tg());
    Ve.IX2ElementsReducer = w1;
    var R1 = br(Wa());
    Ve.IX2VanillaPlugins = R1;
    var C1 = br(Yg());
    Ve.IX2VanillaUtils = C1;
  });
  var Jg = u((_i) => {
    "use strict";
    ...
    var $g = ke(),
      ...
      Ar = ar(),
      {
        ...
        IX2_ANIMATION_FRAME_CHANGED: M1,
      ...
      { RENDER_GENERAL: F1 } = $g.IX2EngineConstants,
      {
      ...
      U1 = (e, t) => {
        ...
        let b = Math.max(A, 0) || 0,
          ...
          P = E ? p : Ei(r + D * y),
          q = P * 100;
        if (P === r && e.current) return e;
        let w, V, X, F;
        for (let Q = 0, { length: Y } = o; Q < Y; Q++) {
          let { keyframe: ie, actionItems: W } = o[Q];
          if ((Q === 0 && (w = W[0]), q >= ie)) {
            w = W[0];
            let x = o[Q + 1],
              v = x && q !== ie;
            (V = v ? x.actionItems[0] : null),
              v && ((X = ie / 100), (F = (x.keyframe - ie) / 100));
          }
        }
        let B = {};
        if (w && !V)
          for (let Q = 0, { length: Y } = i; Q < Y; Q++) {
            let ie = i[Q];
            B[ie] = Ja(c, ie, w.config);
          }
        else if (w && V && X !== void 0 && F !== void 0) {
          let Q = (P - X) / F,
            Y = w.config.easing,
            ie = Zg(Y, Q, d);
      ...
      V1 = (e, t) => {
        ...
        if (r && n) {
          ...
          if (s) {
            let Q = q - o,
              Y = D + P,
              ie = Ei(Math.min(Math.max(0, Q / Y), 1));
            e = (0, Ar.set)(e, "verboseTimeElapsed", Y * ie);
          }
          if (w < 0) return e;
          let V = Ei(Math.min(Math.max(0, w / D), 1)),
            X = Zg(b, V, y),
            F = {},
            B = null;
          return (
        ...
        switch (t.type) {
          ...
          case P1: {
            let {
              ...
              ie = G1(Y),
              W = X1(ie, Y),
              x = Object.keys(_).filter(
                (M) => _[M] != null && typeof _[M] != "string"
              ),
              { easing: v } = o.config;
            return (0, Ar.set)(e, r, {
              id: r,
              ...
              skipToValue: Q,
              customEasingFn:
                Array.isArray(v) && v.length === 4 ? D1(v) : void 0,
            });
          }
          case q1: {
            let { instanceId: r, time: n } = t.payload;
            return (0, Ar.mergeIn)(e, [r], {
              active: !0,
              complete: !1,
              start: n,
            });
          ...
          case M1: {
            ...
            for (let i = 0; i < o; i++) {
              let a = n[i],
                s = e[a],
                c = s.continuous ? U1 : V1;
              r = (0, Ar.set)(r, a, c(s, t));
            }
            return r;
          }
          default:
  ...
  var tE = u((mi) => {
    ...
    var z1 = Zo(),
      ...
      r2 = (0, z1.combineReducers)({
        ixData: Y1.ixData,
        ixRequest: $1.ixRequest,
  ...
  var EE = u((Rj, gE) => {
    var lE = "\\ud800-\\udfff",
      ...
      vE = S2 + "?",
      hE = "[" + b2 + "]?",
      R2 = "(?:" + w2 + "(?:" + [fE, dE, pE].join("|") + ")" + hE + vE + ")*",
      C2 = hE + vE + R2,
      N2 = "(?:" + [fE + es + "?", es, dE, pE, A2].join("|") + ")",
      cE = RegExp(ts + "(?=" + ts + ")|" + N2 + C2, "g");
    function x2(e) {
  ...
  var IE = u((Nj, mE) => {
    ...
    function B2(e) {
      if (e == null) return 0;
      if (G2(e)) return X2(e) ? U2(e) : e.length;
      var t = F2(e);
  ...
  var rs = u((Pj, bE) => {
    var j2 = Rt(),
      K2 = (function () {
        try {
          var e = j2(Object, "defineProperty");
          return e({}, "", {}), e;
        } catch {}
      })();
    bE.exports = K2;
  ...
  var ns = u((qj, SE) => {
    ...
    function z2(e, t, r) {
      t == "__proto__" && AE
        ? AE(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 })
        : (e[t] = r);
    }
    SE.exports = z2;
  });
  var RE = u((Lj, wE) => {
    ...
    function J2(e, t, r) {
      var n = e[t];
      (!(Z2.call(e, t) && $2(n, r)) || (r === void 0 && !(t in e))) &&
        Y2(e, t, r);
    }
    wE.exports = J2;
  });
    ...
    function gG(e, t, r) {
      ...
      (t = a_(t) || 0),
        dG(r) &&
          ((E = !!r.leading),
          (p = "maxWait" in r),
          (i = p ? vG(a_(r.maxWait) || 0, t) : i),
          (_ = "trailing" in r ? !!r.trailing : _));
      function y(F) {
        var B = n,
          Q = o;
        return (n = o = void 0), (d = F), (a = e.apply(Q, B)), a;
      }
      function A(F) {
        return (d = F), (s = setTimeout(P, t)), E ? y(F) : a;
      }
      function b(F) {
        var B = F - c,
          Q = F - d,
      ...
      function q(F) {
        return (s = void 0), _ && n ? y(F) : ((n = o = void 0), a);
      }
      function w() {
        s !== void 0 && clearTimeout(s), (d = 0), (n = c = o = s = void 0);
      }
      function V() {
        return s === void 0 ? a : q(is());
      }
      function X() {
        var F = is(),
          B = D(F);
        if (((n = arguments), (o = this), (c = F), B)) {
          if (s === void 0) return A(c);
          if (p) return clearTimeout(s), (s = setTimeout(P, t)), y(c);
        }
  ...
  var l_ = u((Qj, c_) => {
    ...
    function mG(e, t, r) {
      ...
      return (
        ...
        EG(e, t, { leading: n, maxWait: t, trailing: o })
      );
    }
    c_.exports = mG;
  });
  var Ii = u((ue) => {
    ...
    var f_ = IG(or()),
      ...
      kG = (e) => ({ type: OG, payload: (0, f_.default)({}, BG(e)) });
    ue.rawDataImported = kG;
    var HG = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({
      type: bG,
      payload: { hasBoundaryNodes: e, reducedMotion: t },
    });
    ue.sessionInitialized = HG;
    var jG = () => ({ type: AG });
    ue.sessionStarted = jG;
    var KG = () => ({ type: SG });
    ue.sessionStopped = KG;
    var zG = ({ rawData: e, defer: t }) => ({
      type: wG,
      payload: { defer: t, rawData: e },
    });
    ue.previewRequested = zG;
    var YG = ({
    ...
    ue.playbackRequested = YG;
    var $G = (e) => ({ type: CG, payload: { actionListId: e } });
    ue.stopRequested = $G;
    var QG = () => ({ type: NG });
    ue.clearRequested = QG;
    var ZG = (e, t) => ({
      type: xG,
      payload: { target: e, listenerParams: t },
    });
    ue.eventListenerAdded = ZG;
    var JG = (e = 1) => ({ type: PG, payload: { step: e } });
    ue.testFrameRendered = JG;
    var eX = (e, t) => ({ type: qG, payload: { stateKey: e, newState: t } });
    ue.eventStateChanged = eX;
    var tX = (e, t) => ({ type: LG, payload: { now: e, parameters: t } });
    ue.animationFrameChanged = tX;
    var rX = (e, t) => ({ type: MG, payload: { key: e, value: t } });
    ue.parameterChanged = rX;
    var nX = (e) => ({ type: DG, payload: (0, f_.default)({}, e) });
    ue.instanceAdded = nX;
    var iX = (e, t) => ({ type: FG, payload: { instanceId: e, time: t } });
    ue.instanceStarted = iX;
    var oX = (e) => ({ type: GG, payload: { instanceId: e } });
    ue.instanceRemoved = oX;
    var aX = (e, t, r, n) => ({
      type: XG,
      payload: { elementId: e, actionTypeId: t, current: r, actionItem: n },
    });
    ue.elementStateChanged = aX;
    var sX = ({ actionListId: e, isPlaying: t }) => ({
      type: UG,
      payload: { actionListId: e, isPlaying: t },
    });
    ue.actionListPlaybackChanged = sX;
    var uX = ({ width: e, mediaQueries: t }) => ({
      type: VG,
      payload: { width: e, mediaQueries: t },
    });
    ue.viewportWidthChanged = uX;
    var cX = () => ({ type: WG });
    ue.mediaQueriesDefined = cX;
  });
  var h_ = u((Me) => {
    "use strict";
    Object.defineProperty(Me, "__esModule", { value: !0 });
    Me.elementContains = IX;
    Me.getChildElements = OX;
    Me.getClosestElement = void 0;
    Me.getProperty = gX;
    Me.getQuerySelector = _X;
    Me.getRefType = SX;
    Me.getSiblingElements = bX;
    Me.getStyle = hX;
    Me.getValidDocument = yX;
    Me.isSiblingNode = TX;
    Me.matchSelector = EX;
    Me.queryDocument = mX;
    Me.setStyle = vX;
    var lX = Kt(),
      fX = ke(),
      { ELEMENT_MATCHES: os } = lX.IX2BrowserSupport,
      {
        IX2_ID_DELIMITER: p_,
        HTML_ELEMENT: dX,
        PLAIN_OBJECT: pX,
    ...
    var AX = Element.prototype.closest
  ...
  var us = u((EK, ty) => {
    ...
    function lU(e) {
      for (
        var t = e.name + "", r = ey[t], n = cU.call(ey, t) ? r.length : 0;
        n--;
  ...
  var cy = u((IK, uy) => {
    var yU = Si(),
      ...
      OU = ay(),
      bU = Object.prototype,
      AU = bU.hasOwnProperty;
    function wi(e) {
      if (TU(e) && !IU(e) && !(e instanceof yU)) {
        if (e instanceof sy) return e;
        if (AU.call(e, "__wrapped__")) return OU(e);
      }
      return new sy(e);
    }
    wi.prototype = mU.prototype;
  ...
  var hy = u((OK, vy) => {
    ...
    function XU(e) {
      return xU(function (t) {
        ...
        for (e && t.reverse(); n--; ) {
          var i = t[n];
          if (typeof i != "function") throw new TypeError(LU);
          if (o && !a && cs(i) == "wrapper") var a = new dy([], !0);
        }
        for (n = a ? n : r; ++n < r; ) {
          i = t[n];
          var s = cs(i),
        ...
        return function () {
          var d = arguments,
            E = d[0];
          if (a && d.length == 1 && qU(E)) return a.plant(E).value();
          for (var p = 0, _ = r ? t[p].apply(this, d) : E; ++p < r; )
            _ = t[p].call(this, _);
          return _;
        };
      });
  ...
  var Xy = u((Pi) => {
    ...
    var Ye = xi(or()),
      ...
      { COLON_DELIMITER: Ty } = zt.IX2EngineConstants,
      { getNamespacedParameterId: Oy } = zU.IX2VanillaUtils,
      My = (e) => (t) => typeof t == "object" && e(t) ? !0 : t,
      un = My(({ element: e, nativeEvent: t }) => e === t.target),
      gV = My(({ element: e, nativeEvent: t }) => e.contains(t.target)),
      Et = (0, HU.default)([un, gV]),
      Dy = (e, t) => {
        if (t) {
          let { ixData: r } = e.getState(),
            { events: n } = r,
        ...
        return (
          d &&
            (0, fs.stopActionGroup)({
              ...
              actionListId: (0, jU.default)(d, "action.config.actionListId"),
            }),
          (0, fs.stopActionGroup)({
            store: e,
            eventId: a,
      ...
      cn = { handler: ot(Et, je) },
      Fy = (0, Ye.default)({}, cn, { types: [ds, Ly].join(" ") }),
      ps = [
      ...
      vs = { types: ps },
      _V = { PAGE_START: qy, PAGE_FINISH: Py },
      sn = (() => {
      ...
      IV = (e) => {
        ...
        return yV(t.getBoundingClientRect(), {
          left: 0,
          top: c,
          right: n,
          bottom: o - c,
      ...
      Gy = (e) => (t, r) => {
        let { type: n } = t.nativeEvent,
          o = [ds, Ly].indexOf(n) !== -1 ? n === ds : r.isActive,
      ...
      TV = (e) => (t, r) => {
        let n = (0, Ye.default)({}, r, { elementVisible: IV(t) });
        return (
      ...
      Sy =
        ...
        (t, r = {}) => {
          ...
          return (r && P && (b || q.inBounds !== r.inBounds) && e(t, q)) || q;
        },
      OV = (e, t) =>
        e.left > t.left &&
        e.left < t.right &&
      ...
      Ci = (e = !0) =>
        (0, Ye.default)({}, Fy, {
          handler: ot(
            e ? Et : un,
            Gy((t, r) => (r.isActive ? cn.handler(t, r) : r))
          ),
        }),
      Ni = (e = !0) =>
        (0, Ye.default)({}, Fy, {
          handler: ot(
            e ? Et : un,
            Gy((t, r) => (r.isActive ? r : cn.handler(t, r)))
          ),
        }),
      Ry = (0, Ye.default)({}, vs, {
        handler: TV((e, t) => {
      ...
      SV = {
        ...
        [oV]: Ci(),
        [aV]: Ni(),
        [vV]: { types: "ecommerce-cart-open", handler: ot(Et, je) },
        [pV]: { types: "ecommerce-cart-close", handler: ot(Et, je) },
        [YU]: {
          types: "click",
          handler: ot(
            Et,
        ...
        [QU]: (0, Ye.default)({}, cn, { types: "mousedown" }),
        [ZU]: (0, Ye.default)({}, cn, { types: "mouseup" }),
        [JU]: {
          types: by,
          handler: ot(
            Et,
          ...
          handler: (
            ...
            switch (a) {
              ...
              case zt.EventBasedOn.PAGE: {
                ...
                P = b ? Math.min(V + y, F) / F : Math.min(X + A, B) / B;
                break;
              }
              ...
              default: {
                ...
                if (V && Et({ element: t, nativeEvent: n }) !== !0) break;
                let X = t.getBoundingClientRect(),
                  { left: F, top: B, width: Q, height: Y } = X;
                if (!V && !OV({ left: p, top: _ }, X)) break;
                (w = !0), (P = b ? (p - F) / Q : (_ - B) / Y);
                break;
              }
            }
            return (
              D && (P > 1 - Cy || P < Cy) && (P = Math.round(P)),
              (a !== zt.EventBasedOn.ELEMENT || w || w !== i.elementHovered) &&
                ((P = d ? 1 - P : P),
                e.dispatch((0, Ri.parameterChanged)(q, P))),
              { elementHovered: w, clientX: p, clientY: _, pageX: y, pageY: A }
            );
          },
        },
        [hV]: {
        ...
        [dV]: {
          ...
          handler: (
            ...
            if (E === zt.EventBasedOn.VIEWPORT) {
              ...
              return (
                V !== o.scrollPercent &&
                  t.dispatch((0, Ri.parameterChanged)(_, V)),
                { scrollPercent: V }
              );
            } else {
              let V = Oy(n, _),
                ...
                B = (b ? q : 0) / 100;
              (F = y ? F : 1 - F), (B = A ? B : 1 - B);
              let Q = X.top + Math.min(X.height * F, d),
                ie = X.top + X.height * B - Q,
                W = Math.min(d + ie, c),
                v = Math.min(Math.max(0, d - Q), W) / W;
              return (
                v !== o.scrollPercent &&
                  t.dispatch((0, Ri.parameterChanged)(V, v)),
                { scrollPercent: v }
              );
            }
          },
  ...
  var hs = u((qt) => {
    ...
    qt.observeRequests = nW;
    qt.startActionGroup = Is;
    qt.startEngine = Fi;
    qt.stopActionGroup = ms;
    ...
    var RV = st(or()),
      ...
      GV = Object.keys(at.QuickEffectIds),
      gs = (e) => GV.includes(e),
      {
        COLON_DELIMITER: Es,
      ...
      } = Wy.IX2VanillaUtils,
      {
        ...
        getPluginDuration: eW,
      } = Wy.IX2VanillaPlugins,
      Vy = navigator.userAgent,
      tW = Vy.match(/iPad/i) || Vy.match(/iPhone/),
      rW = 12;
    function nW(e) {
      Yt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: aW }),
        Yt({
          store: e,
          select: ({ ixRequest: t }) => t.playback,
          onChange: sW,
        }),
        Yt({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: uW }),
        Yt({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: cW });
    }
    function iW(e) {
      Yt({
        store: e,
    ...
    function aW({ rawData: e, defer: t }, r) {
      let n = () => {
        Fi({ store: r, rawData: e, allowEvents: !0 }), Hy();
      };
      t ? setTimeout(n, 0) : n();
    }
    function Hy() {
    ...
    function sW(e, t) {
      ...
      if (n && o && E && s) {
        ...
        p && (E = jV({ actionList: p, actionItemId: o, rawData: E }));
      }
      if (
        (Fi({ store: t, rawData: E, allowEvents: a, testManual: c }),
        (n && r === at.ActionTypeConsts.GENERAL_START_ACTION) || gs(r))
      ) {
        ms({ store: t, actionListId: n }),
    ...
    function uW({ actionListId: e }, t) {
      e ? ms({ store: t, actionListId: e }) : zy({ store: t }), Gi(t);
    }
    function cW(e, t) {
      Gi(t), ky({ store: t, elementApi: Re });
    }
      ...
      t && e.dispatch((0, Oe.rawDataImported)(t)),
        o.active ||
          ...
          r &&
            (hW(e),
            lW(),
            e.getState().ixSession.hasDefinedMediaQueries && iW(e)),
    ...
    function fW(e, t) {
      let r = (n) => {
        ...
        o.active &&
          ...
          t ? oW(e, r) : requestAnimationFrame(r));
      };
    ...
    function Gi(e) {
      ...
      if (t.active) {
        ...
        r.forEach(dW), $V(), e.dispatch((0, Oe.sessionStopped)());
      }
    }
    ...
    function pW({
      ...
      let { ixData: d, ixSession: E } = e.getState(),
        ...
        b = {},
        D = [],
        { continuousActionGroups: P } = a,
        { id: q } = a;
      KV(y, o) && (q = zV(t, q));
      let w = E.hasBoundaryNodes && r ? Re.getClosestElement(r, qi) : null;
      P.forEach((V) => {
        let { keyframe: X, actionItems: F } = V;
        F.forEach((B) => {
          let { actionTypeId: Q } = B,
            { target: Y } = B.config;
          if (!Y) return;
          let ie = Y.boundaryMode ? w : null,
            W = QV(Y) + Es + Q;
          if (((b[W] = vW(b[W], X, B)), !A[W])) {
            A[W] = !0;
            let { config: x } = B;
            Li({
              config: x,
              ...
              D.push({ element: v, key: W });
            });
          }
        });
      }),
        D.forEach(({ element: V, key: X }) => {
          let F = b[X],
            B = (0, Pt.default)(F, "[0].actionItems[0]", {}),
            { actionTypeId: Q } = B,
            Y = Di(Q) ? ys(Q)(V, B) : null,
            ie = _s({ element: V, actionItem: B, elementApi: Re }, Y);
          Ts({
            store: e,
            element: V,
            eventId: n,
    ...
    function IW({ logic: e, store: t, events: r }) {
      ...
      (0, ln.default)(s, (p, _) => {
        let y = r[_],
          { action: A, id: b, mediaQueries: D = i.mediaQueryKeys } = y,
          { actionListId: P } = A.config;
        ZV(D, i.mediaQueryKeys) || t.dispatch((0, Oe.mediaQueriesDefined)()),
          A.actionTypeId === at.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
            (Array.isArray(y.config) ? y.config : [y.config]).forEach((w) => {
              let { continuousParameterGroupId: V } = w,
                X = (0, Pt.default)(a, `${P}.continuousParameterGroups`, []),
                F = (0, NV.default)(X, ({ id: Y }) => Y === V),
                B = (w.smoothing || 0) / 100,
                Q = (w.restingState || 0) / 100;
              F &&
                p.forEach((Y, ie) => {
                  let W = b + Es + ie;
                  pW({
          ...
          (A.actionTypeId === at.ActionTypeConsts.GENERAL_START_ACTION ||
            gs(A.actionTypeId)) &&
            Ky({ store: t, actionListId: P, eventId: b });
      });
      let c = (p) => {
          ...
          yW(s, (y, A, b) => {
            let D = r[A],
              P = _.eventState[b],
              { action: q, mediaQueries: w = i.mediaQueryKeys } = D;
            if (!Mi(w, _.mediaQueryKey)) return;
            let V = (X = {}) => {
              let F = o(
                {
                  store: t,
              ...
              JV(F, P) || t.dispatch((0, Oe.eventStateChanged)(b, F));
            };
            q.actionTypeId === at.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
              ? (Array.isArray(D.config) ? D.config : [D.config]).forEach(V)
              : V();
          });
        },
        d = (0, MV.default)(c, rW),
        E = ({ target: p = document, types: _, throttle: y }) => {
          _.split(" ")
            .filter(Boolean)
            .forEach((A) => {
              let b = y ? d : c;
              p.addEventListener(A, b),
                t.dispatch((0, Oe.eventListenerAdded)(p, [A, b]));
            });
        };
    ...
    function Ky({ store: e, actionListId: t, eventId: r }) {
      ...
      if (c && c.useFirstGroupAsInitialState) {
        let d = (0, Pt.default)(c, "actionItemGroups[0].actionItems", []),
          E = (0, Pt.default)(s, "mediaQueries", n.mediaQueryKeys);
        if (!Mi(E, o.mediaQueryKey)) return;
        d.forEach((p) => {
          var _;
          let { config: y, actionTypeId: A } = p,
            b =
              (y == null || (_ = y.target) === null || _ === void 0
                ...
                : y,
            D = Li({ config: b, event: s, elementApi: Re }),
            P = Di(A);
          D.forEach((q) => {
            let w = P ? ys(A)(q, p) : null;
            Ts({
              destination: _s({ element: q, actionItem: p, elementApi: Re }, w),
              immediate: !0,
              store: e,
              element: q,
              eventId: r,
    ...
    function Is({
      ...
      let { ixData: d, ixSession: E } = e.getState(),
        { events: p } = d,
        _ = p[t] || {},
        { mediaQueries: y = d.mediaQueryKeys } = _,
        A = (0, Pt.default)(d, `actionLists.${o}`, {}),
        { actionItemGroups: b, useFirstGroupAsInitialState: D } = A;
      if (!b || !b.length) return !1;
      i >= b.length && (0, Pt.default)(_, "config.loop") && (i = 0),
        i === 0 && D && i++;
      let q =
          (i === 0 || (i === 1 && D)) &&
          gs((c = _.action) === null || c === void 0 ? void 0 : c.actionTypeId)
            ? _.config.delay
            : void 0,
        w = (0, Pt.default)(b, [i, "actionItems"], []);
      if (!w.length || !Mi(y, E.mediaQueryKey)) return !1;
      let V = E.hasBoundaryNodes && r ? Re.getClosestElement(r, qi) : null,
        X = BV(w),
        F = !1;
      return (
        w.forEach((B, Q) => {
          let { config: Y, actionTypeId: ie } = B,
            W = Di(ie),
            { target: x } = Y;
          if (!x) return;
          let v = x.boundaryMode ? V : null;
          Li({
            config: Y,
            event: _,
            eventTarget: r,
            ...
            let $ = W ? ys(ie)(N, B) : null,
              re = W ? eW(ie)(N, B) : null;
            F = !0;
            let G = X === Q && U === 0,
              H = kV({ element: N, actionItem: B }),
              f = _s({ element: N, actionItem: B, elementApi: Re }, $);
            Ts({
              store: e,
              element: N,
              actionItem: B,
    ...
    function Ts(e) {
      ...
      let { store: r, computedStyle: n } = e,
        ...
        _ = !d,
        y = VV(),
        { ixElements: A, ixSession: b, ixData: D } = r.getState(),
        P = UV(A, i),
        { refState: q } = A[P] || {},
        w = Re.getRefType(i),
        V = b.reducedMotion && at.ReducedMotionTypes[a.actionTypeId],
        X;
      if (V && d)
        switch (
      ...
      if (
        ...
        Yy(document.body, "ix2-animation-started", y),
        s)
      ) {
        OW(r, y);
        return;
      }
      Yt({ store: r, select: ({ ixInstances: B }) => B[y], onChange: $y }),
        _ && r.dispatch((0, Oe.instanceStarted)(y, b.tick));
    }
    function Os(e, t) {
      ...
      let { elementId: r, actionItem: n } = e,
        ...
        { ref: i, refType: a } = o[r] || {};
      a === By && YV(i, n, Re), t.dispatch((0, Oe.instanceRemoved)(e.id));
    }
    function Yy(e, t, r) {
    ...
    function $y(e, t) {
      let {
        ...
        { ixData: w, ixSession: V } = t.getState(),
        { events: X } = w,
        F = X[p] || {},
        { mediaQueries: B = w.mediaQueryKeys } = F;
      if (Mi(B, V.mediaQueryKey) && (n || r || o)) {
        if (d || (c === XV && o)) {
          t.dispatch((0, Oe.elementStateChanged)(i, s, d, a));
          let { ixElements: Q } = t.getState(),
            { ref: Y, refType: ie, refState: W } = Q[i] || {},
            x = W && W[s];
          (ie === By || Di(s)) && WV(Y, W, x, p, a, D, Re, c, q);
        }
        if (o) {
          if (b) {
            let Q = Is({
  ...
  var Zy = u((Ot) => {
    ...
    var SW = Zo(),
      ...
      RW = bW(Ii());
    Ot.actions = RW;
    var Xi = (0, SW.createStore)(wW.default);
    Ot.store = Xi;
    function CW(e) {
      e() && (0, bs.observeRequests)(Xi);
    }
    function NW(e) {
      Qy(), (0, bs.startEngine)({ store: Xi, rawData: e, allowEvents: !0 });
    }
    function Qy() {
      (0, bs.stopEngine)(Xi);
    }
      ...
      (nm.exports = function (e, t) {
        ...
        function y() {
          (o = i && Sr.env("design")),
            ...
            Sr.scroll.off(b),
            (p = []);
          for (var P = document.links, q = 0; q < P.length; ++q) A(P[q]);
          p.length && (Sr.scroll.on(b), b());
        }
        function A(P) {
          var q =
            (o && P.getAttribute("href-disabled")) || P.getAttribute("href");
          if (((s.href = q), !(q.indexOf(":") >= 0))) {
            ...
            if (
              ...
              var V = e(s.hash);
              V.length && p.push({ link: w, sec: V, active: !1 });
              return;
            }
            if (!(q === "#" || q === "")) {
              var X = s.href === a.href || q === _ || (d.test(q) && E.test(_));
              D(w, c, X);
            }
          }
        }
        function b() {
          ...
          t.each(p, function (w) {
            var V = w.link,
              ...
              B = X.outerHeight(),
              Q = q * 0.5,
              Y = X.is(":visible") && F + B - Q >= P && F + Q <= P + q;
            w.active !== Y && ((w.active = Y), D(V, c, Y));
          });
        }
        function D(P, q, w) {
          var V = P.hasClass(q);
          (w && V) || (!w && !V) || (w ? P.addClass(q) : P.removeClass(q));
        }
        return r;
      })
    );
    ...
    Ui.define(
      ...
      (om.exports = function (e) {
        ...
        function F(x, v) {
          ...
          if (M !== N) {
            var U = Q(x, M, N),
              ...
              re = function () {
                var G = Date.now() - $;
                window.scroll(0, Y(M, N, G, U)),
                  G <= U ? s(re) : typeof v == "function" && v();
              };
            s(re);
          }
        }
        ...
        function Q(x, v, M) {
          ...
          var N = 1;
          return (
            a.add(x).each(function (U, $) {
              var re = parseFloat($.getAttribute("data-scroll-time"));
              !isNaN(re) && re >= 0 && (N = re);
            }),
            (472.143 * Math.log(Math.abs(v - M) + 125) - 2e3) * N
          );
        }
        function Y(x, v, M, N) {
          return M > N ? v : x + (v - x) * ie(M / N);
        }
        function ie(x) {
          return x < 0.5
            ? 4 * x * x * x
      ...
      (sm.exports = function (e) {
        ...
        function n(i) {
          ...
          function p(D) {
            ...
            (P && P.length > 1) ||
              ((a = !0),
              P ? ((s = !0), (d = P[0].clientX)) : (d = D.clientX),
              (E = d));
          }
          function _(D) {
            if (a) {
              ...
              var P = D.touches,
                q = P ? P[0].clientX : D.clientX,
                w = q - E;
              (E = q),
                Math.abs(w) > c &&
                  r &&
                  String(r()) === "" &&
                  (o("swipe", D, { direction: w > 0 ? "right" : "left" }), A());
            }
          }
          function y(D) {
    ...
    As.define(
      ...
      (cm.exports = function (e, t) {
        ...
        function V() {
          (y = !0),
            n.on("submit", s + " form", function (Z) {
              ...
              ee.handler && ((ee.evt = Z), ee.handler(ee));
            });
          ...
          n.on(
            ...
            (Z) => {
              e(Z.target).siblings(G).toggleClass(f);
            }
          ),
            n.on("change", s + ' form input[type="radio"]', (Z) => {
              e(`input[name="${Z.target.name}"]:not(${G})`).map((de, be) =>
                e(be).siblings(H).removeClass(f)
              );
              let ee = e(Z.target);
              ee.hasClass("w-radio-input") || ee.siblings(H).addClass(f);
            }),
            j.forEach(([Z, ee]) => {
              n.on(
                "focus",
                s + ` form input[type="${Z}"]:not(` + ee + ")",
                (de) => {
                  e(de.target).siblings(ee).addClass(m),
                    e(de.target).filter(h).siblings(ee).addClass(I);
                }
              ),
                n.on(
                  "blur",
                  s + ` form input[type="${Z}"]:not(` + ee + ")",
                  (de) => {
                    e(de.target).siblings(ee).removeClass(`${m} ${I}`);
                  }
                );
            });
        }
        ...
        function F(G) {
          var H = G.btn,
            f = G.wait;
          H.prop("disabled", !0), f && ((G.label = H.val()), H.val(f));
        }
        function B(G, H) {
          var f = null;
          return (
            ...
            G.find(':input:not([type="submit"]):not([type="file"])').each(
              function (m, I) {
                var h = e(I),
                  j = h.attr("type"),
                  Z =
                    h.attr("data-name") || h.attr("name") || "Field " + (m + 1),
                  ee = h.val();
                if (j === "checkbox") ee = h.is(":checked");
                else if (j === "radio") {
        ...
        function Q(G) {
          var H = {};
          return (
            G.find(':input[type="file"]').each(function (f, m) {
              var I = e(m),
                h = I.attr("data-name") || I.attr("name") || "File " + (f + 1),
                j = I.attr("data-value");
              typeof j == "string" && (j = e.trim(j)), (H[h] = j);
            }),
            H
          );
        }
          ...
          return (
            H === "password"
              ...
              ? m
                ? d.test(G.attr("type")) &&
                  (E.test(m) ||
                    (I = "Please enter a valid email address for: " + f))
                : (I = "Please fill out the required field: " + f)
        ...
        function v(G) {
          ...
          F(G);
          var I;
          t.each(f, function (ee, de) {
            d.test(de) && (f.EMAIL = ee),
              /^((full[ _-]?)?name)$/i.test(de) && (I = ee),
              /^(first[ _-]?name)$/i.test(de) && (f.FNAME = ee),
              /^(last[ _-]?name)$/i.test(de) && (f.LNAME = ee);
          }),
            I &&
              !f.FNAME &&
              ((I = I.split(" ")),
              (f.FNAME = I[0]),
              (f.LNAME = f.LNAME || I[1]));
          var h = G.action.replace("/post?", "/post-json?") + "&c=?",
            j = h.indexOf("u=") + 2;
          ...
          (Z = h.substring(Z, h.indexOf("&", Z))),
            (f["b_" + j + "_" + Z] = ""),
            e
              .ajax({ url: h, data: f, dataType: "jsonp" })
              .done(function (ee) {
        ...
        function U(G, H) {
          ...
          if (
            (_ ||
              de.on("click keydown", function (O) {
                (O.type === "keydown" && O.which !== 13 && O.which !== 32) ||
                  (O.preventDefault(), ee.click());
              }),
            ...
            ee.height($e), ee.width(1);
          }
          function l(O) {
            var C = O.responseJSON && O.responseJSON.msg,
              te = We;
          ...
          function T(O, C) {
            ...
            var te = C.fileName,
              ...
              _e = C.fileId,
              z = C.s3Url;
            ee.attr("data-value", _e), re(z, oe, f, te, S);
          }
          function S(O) {
            if (O) return l(O);
            h.toggle(!1),
        ...
        function $(G, H) {
          ...
          e.ajax({ type: "GET", url: `${b}?${f}`, crossDomain: !0 })
            .done(function (m) {
              H(null, m);
            })
            .fail(function (m) {
        ...
        function re(G, H, f, m, I) {
          var h = new FormData();
          for (var j in H) h.append(j, H[j]);
          h.append("file", f, m),
            e
              .ajax({
                type: "POST",
    ...
    Lt.define(
      ...
      (fm.exports = function (e, t) {
        var r = {},
          ...
          P = "w--nav-dropdown-list-open",
          q = "w--nav-link-open",
          w = PW.triggers,
          V = e();
        (r.ready = r.design = r.preview = X),
          (r.destroy = function () {
            (V = e()), F(), c && c.length && c.each(ie);
          });
        function X() {
          (d = p && Lt.env("design")),
            (E = Lt.env("editor")),
        ...
        function Y(g, k) {
          ...
          ve &&
            ...
            v(K),
            d
              ? (W(K), K.el.on("setting" + y, M(K)))
              : (x(K),
                K.button.on("click" + y, G(K)),
                K.menu.on("click" + y, "a", H(K)),
                K.button.on("keydown" + y, N(K)),
                K.el.on("keydown" + y, U(K))),
            I(g, k);
        }
        function ie(g, k) {
          var J = e.data(k, y);
          J && (W(J), e.removeData(k, y));
        }
        function W(g) {
          g.overlay && (ce(g, !0), g.overlay.remove(), (g.overlay = null));
        }
        function x(g) {
          g.overlay ||
            ((g.overlay = e(_).appendTo(g.el)),
        ...
        function v(g) {
          var k = {},
            J = g.config || {},
            K = (k.animation = g.el.attr("data-animation") || "default");
          (k.animOver = /^over/.test(K)),
            (k.animDirect = /left$/.test(K) ? -1 : 1),
            J.animation !== K && g.open && t.defer(re, g),
        ...
        function N(g) {
          return function (k) {
            switch (k.keyCode) {
              ...
              case De.ESCAPE:
                return ce(g), k.preventDefault(), k.stopPropagation();
              case De.ARROW_RIGHT:
              case De.ARROW_DOWN:
              case De.HOME:
              case De.END:
        ...
        function f(g) {
          return (
            g.outside && i.off("click" + y, g.outside),
            function (k) {
              var J = e(k.target);
              (E && J.closest(".w-editor-bem-EditorOverlay").length) || m(g, J);
            }
          );
        }
        var m = a(function (g, k) {
          if (g.open) {
        ...
        function I(g, k) {
          ...
          if ((J.open && !K && !d && ce(J, !0), J.container.length)) {
            var ve = j(J);
        ...
        var h = "max-width";
        function j(g) {
          var k = g.container.css(h);
          return (
            k === "none" && (k = ""),
            function (J, K) {
              (K = e(K)), K.css(h, ""), K.css(h) === "none" && K.css(h, k);
            }
          );
        }
        function Z(g, k) {
        ...
        function de(g, k) {
          ...
          (g.open = !0),
            g.menu.each(Z),
            g.links.addClass(q),
            g.dropdowns.addClass(b),
            g.dropdownToggle.addClass(D),
            g.dropdownList.addClass(P),
            g.button.addClass(A);
          var J = g.config,
            K = J.animation;
          (K === "none" || !n.support.transform || J.duration <= 0) && (k = !0);
          var ve = be(g),
            We = g.menu.outerHeight(!0),
            $e = g.menu.outerWidth(!0),
            l = g.el.height(),
            T = g.el[0];
          if (
            (I(0, T),
          ...
          if (
            (g.overlay &&
              ((V = g.menu.prev()), g.overlay.show().append(g.menu)),
            J.animOver)
          ) {
            n(g.menu)
              .add(S)
              .set({ x: J.animDirect * $e, height: ve })
              .start({ x: 0 })
              .then(O),
              g.overlay && g.overlay.width($e);
            return;
          }
          var R = l + We;
          n(g.menu).add(S).set({ y: -R }).start({ y: 0 }).then(O);
          function O() {
        ...
        function be(g) {
          var k = g.config,
            J = k.docHeight ? i.height() : s.height();
          return (
            k.animOver
              ? g.menu.height(J)
        ...
        function ce(g, k) {
          ...
          var l = $e + ve;
          n(g.menu).add(K).start({ y: -l }).then(T);
          function T() {
            g.menu.height(""),
              n(g.menu).set({ x: 0, y: 0 }),
              g.menu.each(ee),
              g.links.removeClass(q),
              g.dropdowns.removeClass(b),
              g.dropdownToggle.removeClass(D),
              g.dropdownList.removeClass(P),
              g.overlay &&
                g.overlay.children().length &&
                (V.length ? g.menu.insertAfter(V) : g.menu.prependTo(g.parent),
    ...
    Mt.define(
      ...
      (vm.exports = function (e, t) {
        ...
        (r.ready = function () {
          ...
          (r.destroy = D);
        function b() {
          (i = o.find(c)), i.length && (i.each(w), !y && (D(), P()));
        }
        function D() {
          Mt.resize.off(q), Mt.redraw.off(r.redraw);
        }
        function P() {
          Mt.resize.on(q), Mt.redraw.on(r.redraw);
        }
        function q() {
        ...
        function w(f, m) {
          ...
          h ||
            ...
            (h.mask = I.children(".w-slider-mask")),
            (h.left = I.children(".w-slider-arrow-left")),
            (h.right = I.children(".w-slider-arrow-right")),
            (h.nav = I.children(".w-slider-nav")),
            (h.slides = h.mask.children(".w-slide")),
            h.slides.each(_.reset),
            A && (h.maskWidth = 0),
            I.attr("role") === void 0 && I.attr("role", "region"),
            I.attr("aria-label") === void 0 && I.attr("aria-label", "carousel");
          var j = h.mask.attr("id");
          if (
            (j || ((j = "w-slider-mask-" + f), h.mask.attr("id", j)),
            !a && !h.ariaLiveLabel && (h.ariaLiveLabel = e(E).appendTo(h.mask)),
            ...
            h.left.hide(), h.right.hide(), h.nav.hide(), (y = !0);
            return;
          }
          h.el.off(c),
            h.left.off(c),
            ...
            V(h),
            a
              ? (h.el.on("setting" + c, v(h)), x(h), (h.hasTimer = !1))
              : (h.el.on("swipe" + c, v(h)),
                h.left.on("click" + c, Q(h)),
                h.right.on("click" + c, Y(h)),
                h.left.on("keydown" + c, B(h, Q)),
                h.right.on("keydown" + c, B(h, Y)),
                h.nav.on("keydown" + c, "> div", v(h)),
                h.config.autoplay &&
                  !h.hasTimer &&
                  ((h.hasTimer = !0), (h.timerCount = 1), W(h)),
                h.el.on("mouseenter" + c, F(h, !0, "mouse")),
                h.el.on("focusin" + c, F(h, !0, "keyboard")),
                h.el.on("mouseleave" + c, F(h, !1, "mouse")),
                h.el.on("focusout" + c, F(h, !1, "keyboard"))),
            h.nav.on("click" + c, "> div", v(h)),
            s ||
              h.mask
                .contents()
                .filter(function () {
                ...
                .remove();
          var Z = I.filter(":hidden");
          Z.addClass(p);
          var ee = I.parents(":hidden");
          ee.addClass(p), A || U(f, m), Z.removeClass(p), ee.removeClass(p);
        }
        function V(f) {
          var m = {};
          (m.crossOver = 0),
            (m.animation = f.el.attr("data-animation") || "slide"),
            m.animation === "outin" &&
              ((m.animation = "cross"), (m.crossOver = 0.5)),
            (m.easing = f.el.attr("data-easing") || "ease");
          var I = f.el.attr("data-duration");
          if (
            ((m.duration = I != null ? parseInt(I, 10) : 500),
            X(f.el.attr("data-infinite")) && (m.infinite = !0),
            X(f.el.attr("data-disable-swipe")) && (m.disableSwipe = !0),
            ...
            (m.autoplay = !0),
              (m.delay = parseInt(f.el.attr("data-delay"), 10) || 2e3),
              (m.timerMax = parseInt(f.el.attr("data-autoplay-limit"), 10));
            var h = "mousedown" + c + " touchstart" + c;
            a ||
              f.el.off(h).one(h, function () {
                x(f);
              });
          }
          var j = f.right.width();
          (m.edge = j ? j + 40 : 100), (f.config = m);
        }
        function X(f) {
          return f === "1" || f === "true";
        }
        function F(f, m, I) {
          return function (h) {
            if (m) f.hasFocus[I] = m;
              ...
              e.contains(f.el.get(0), h.relatedTarget) ||
              ((f.hasFocus[I] = m),
              (f.hasFocus.mouse && I === "keyboard") ||
                (f.hasFocus.keyboard && I === "mouse"))
            )
              return;
            m
              ? (f.ariaLiveLabel.attr("aria-live", "polite"),
                f.hasTimer && x(f))
              : (f.ariaLiveLabel.attr("aria-live", "off"), f.hasTimer && W(f));
          };
        }
        function B(f, m) {
          return function (I) {
            switch (I.keyCode) {
              case _t.SPACE:
              case _t.ENTER:
                return m(f)(), I.preventDefault(), I.stopPropagation();
            }
          };
        }
        function Q(f) {
          return function () {
            N(f, { index: f.index - 1, vector: -1 });
          };
        }
        function Y(f) {
          return function () {
        ...
        function ie(f, m) {
          var I = null;
          m === f.slides.length && (b(), $(f)),
            t.each(f.anchors, function (h, j) {
              e(h.els).each(function (Z, ee) {
                e(ee).index() === m && (I = j);
              });
            }),
            I != null && N(f, { index: I, immediate: !0 });
        }
        function W(f) {
          x(f);
          var m = f.config,
        ...
        function v(f) {
          return function (m, I) {
            ...
            var h = f.config;
            if (a && m.type === "setting") {
              if (I.select === "prev") return Q(f)();
              if (I.select === "next") return Y(f)();
              if ((V(f), $(f), I.select == null)) return;
              ie(f, I.select);
              return;
            }
            if (m.type === "swipe")
              return h.disableSwipe || Mt.env("editor")
                ? void 0
                : I.direction === "left"
                ? Y(f)()
                : I.direction === "right"
                ? Q(f)()
                : void 0;
            if (f.nav.has(m.target).length) {
              var j = e(m.target).index();
              if (
                (m.type === "click" && N(f, { index: j }), m.type === "keydown")
              )
                switch (m.keyCode) {
                  case _t.ENTER:
                  case _t.SPACE: {
                    N(f, { index: j }), m.preventDefault();
                    break;
                  }
                  case _t.ARROW_LEFT:
                  case _t.ARROW_UP: {
                    M(f.nav, Math.max(j - 1, 0)), m.preventDefault();
                    break;
                  }
                  case _t.ARROW_RIGHT:
                  case _t.ARROW_DOWN: {
                    M(f.nav, Math.min(j + 1, f.pages)), m.preventDefault();
                    break;
                  }
                  case _t.HOME: {
                    M(f.nav, 0), m.preventDefault();
                    break;
                  }
                  case _t.END: {
                    M(f.nav, f.pages), m.preventDefault();
                    break;
                  }
                  default:
                    return;
        ...
        function N(f, m) {
          ...
          j < 0
            ? ((j = h.length - 1),
              I.infinite &&
                ((Z.x = -f.endX), (Z.from = 0), (Z.to = h[0].width)))
            : j >= h.length &&
              ((j = 0),
              I.infinite &&
                ((Z.x = h[h.length - 1].width),
                (Z.from = -h[h.length - 1].x),
                (Z.to = Z.from - Z.x))),
            (f.index = j);
          var ee = f.nav
            .children()
          ...
          f.nav
            ...
            .attr("tabindex", "-1"),
            I.hideArrows &&
              (f.index === h.length - 1 ? f.right.hide() : f.right.show(),
              f.index === 0 ? f.left.hide() : f.left.show());
          var de = f.offsetX || 0,
            be = (f.offsetX = -h[f.index].x),
            ce = { x: be, opacity: 1, visibility: "" },
            g = e(h[f.index].els),
            k = e(h[f.previous] && h[f.previous].els),
            J = f.slides.not(g),
            K = I.animation,
            ve = I.easing,
            We = Math.round(I.duration),
            $e = m.vector || (f.index > f.previous ? 1 : -1),
            l = "opacity " + We + "ms " + ve,
            T = "transform " + We + "ms " + ve;
          if (
            (g.find(pm).removeAttr("tabindex"),
            g.removeAttr("aria-hidden"),
            g.find("*").removeAttr("aria-hidden"),
            J.find(pm).attr("tabindex", "-1"),
            J.attr("aria-hidden", "true"),
            J.find("*").attr("aria-hidden", "true"),
            a || (g.each(_.intro), J.each(_.outro)),
            m.immediate && !A)
          ) {
            n(g).set(ce), O();
            return;
          ...
          if (
            (a || f.ariaLiveLabel.text(`Slide ${j + 1} of ${h.length}.`),
            K === "cross")
          ) {
            var S = Math.round(We - We * I.crossOver),
              R = Math.round(We - S);
            (l = "opacity " + S + "ms " + ve),
          ...
          I.infinite && Z.x
            ? (n(f.slides.not(k))
                ...
                .add(T)
                .start({ x: be }),
              n(k).set({ visibility: "", x: Z.from }).add(T).start({ x: Z.to }),
              (f.shifted = k))
            : (I.infinite &&
                f.shifted &&
                (n(f.shifted).set({ visibility: "", x: de }),
                (f.shifted = null)),
              n(f.slides).set({ visibility: "" }).add(T).start({ x: be }));
          function O() {
            (g = e(h[f.index].els)),
              (J = f.slides.not(g)),
          ...
          ee < 0 && (ee = 0),
            ...
            f.slides.each(function (be, ce) {
              h - I > ee &&
                (m++,
                (I += Z),
                (f.anchors[m - 1] = { els: [], x: h, width: 0 })),
                (j = e(ce).outerWidth(!0)),
                (h += j),
                (f.anchors[m - 1].width += j),
                f.anchors[m - 1].els.push(ce);
              var g = be + 1 + " of " + f.slides.length;
              e(ce).attr("aria-label", g), e(ce).attr("role", "group");
            }),
            (f.endX = h),
            a && (f.pages = null),
            f.nav.length && f.pages !== m && ((f.pages = m), re(f));
          var de = f.index;
          de >= m && (de = m - 1), N(f, { immediate: !0, index: de });
        }
        function re(f) {
          var m = [],
            I,
            h = f.el.attr("data-nav-spacing");
          h && (h = parseFloat(h) + "px");
          for (var j = 0, Z = f.pages; j < Z; j++)
            (I = e(d)),
              I.attr("aria-label", "Show slide " + (j + 1) + " of " + Z)
                .attr("aria-pressed", "false")
                .attr("role", "button")
                .attr("tabindex", "-1"),
              f.nav.hasClass("w-num") && I.text(j + 1),
              h != null && I.css({ "margin-left": h, "margin-right": h }),
              m.push(I);
          f.nav.empty().append(m);
        }
        function G(f) {
          var m = f.mask.width();
          return f.maskWidth !== m ? ((f.maskWidth = m), !0) : !1;
        }
        function H(f) {
          var m = 0;
          return (
            f.slides.each(function (I, h) {
              m += e(h).outerWidth(!0);
            }),
            f.slidesWidth !== m ? ((f.slidesWidth = m), !0) : !1
          );
        }
        return r;
      })
    ...
    Dt.define(
      ...
      (gm.exports = function (e) {
        ...
        (t.ready = t.design = t.preview = D),
          ...
          (t.destroy = function () {
            (o = n.find(p)), o.length && (o.each(w), P());
          });
        function D() {
          (i = c && Dt.env("design")),
            (o = n.find(p)),
        ...
        function w(W, x) {
          var v = e.data(x, p);
          v &&
            (v.links && v.links.each(A.reset),
            v.panes && v.panes.each(A.reset));
        }
        function V(W, x) {
          var v = p.substr(1) + "-" + W,
            M = e(x),
            N = e.data(x, p);
          if (
            (N || (N = e.data(x, p, { el: M, config: {} })),
            (N.current = null),
            (N.tabIdentifier = v + "-" + d),
            (N.paneIdentifier = v + "-" + E),
            ...
            N.links.on("click" + p, B(N)), N.links.on("keydown" + p, Q(N));
        ...
        function X(W) {
          var x = {};
          x.easing = W.el.attr("data-easing") || "ease";
          var v = parseInt(W.el.attr("data-duration-in"), 10);
          v = x.intro = v === v ? v : 0;
        ...
        function B(W) {
          return function (x) {
            x.preventDefault();
            var v = x.currentTarget.getAttribute(d);
            v && Y(W, { tab: v });
          };
        }
        function Q(W) {
        ...
        function Y(W, x) {
          ...
          if (N !== W.current) {
            ...
            var $ = [],
              re = [];
            W.panes.each(function (I, h) {
              var j = e(h);
              h.getAttribute(d) === N ? $.push(h) : j.hasClass(y) && re.push(h);
            });
            var G = e($),
              H = e(re);
            if (x.immediate || v.immediate) {
              G.addClass(y).each(A.intro),
                H.removeClass(y),
                b || Dt.redraw.up();
              return;
            } else {
              var f = window.scrollX,
                m = window.scrollY;
              U.focus(), window.scrollTo(f, m);
            }
            H.length && v.outro
              ? (H.each(A.outro),
                r(H)
                  .add("opacity " + v.outro + "ms " + M, { fallback: s })
                  .start({ opacity: 0 })
                  .then(() => ie(v, H, G)))
              : ie(v, H, G);
          }
...
Webflow.require("ix2").init({
  events: {
    "e-3": {
      ...
      target: {
        id: "651dadf80c43865b9bc87bc0|1226a95a-7d5c-0779-e4ea-7e37925290eb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-5": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|f9f32b82-5bbc-e9d7-027c-259db2d25edd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-11": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|a6116d27-867c-116a-9e74-3dab06a231fa",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-13": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|a1475f3e-543b-4531-6c97-5295b9faabda",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-15": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|e8eda677-ac06-2789-b77e-ca041ef1c4ed",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-17": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|47722ac9-5461-bd88-e725-952d3c572203",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-19": {
      ...
      config: [
        ...
        {
          continuousParameterGroupId: "a-47-p-2",
          selectedAxis: "Y_AXIS",
          basedOn: "VIEWPORT",
          reverse: false,
          smoothing: 50,
    ...
    "e-20": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|6ae2c675-d0f6-c522-cfbb-70c4f256053e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-22": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|82016c7a-0de0-7e1b-ef6d-811654048383",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-28": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|49b650ed-7329-42eb-cee8-e1c264af78b1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-30": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|49b650ed-7329-42eb-cee8-e1c264af78ca",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-32": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|64947507-6816-5aa0-1bb4-0525fec231af",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-34": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|17dba825-ed60-3092-d8f5-bd42c76747a7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-36": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|eb6c9711-ba01-8fb9-0aaa-c56ccb18776a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-38": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|3bd87b7a-b7ad-eb86-0318-3e207e070bb8",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-40": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|3bd87b7a-b7ad-eb86-0318-3e207e070bc4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-42": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|3bd87b7a-b7ad-eb86-0318-3e207e070bd0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-44": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|3bd87b7a-b7ad-eb86-0318-3e207e070bdc",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-46": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|69364dac-44e0-f729-d0af-b31f4f460cc4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-48": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|69364dac-44e0-f729-d0af-b31f4f460cd0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-50": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|69364dac-44e0-f729-d0af-b31f4f460cdd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-52": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|69364dac-44e0-f729-d0af-b31f4f460cea",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-54": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|c4e94d44-bca7-2686-da75-d34aad852bb8",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-56": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|c4e94d44-bca7-2686-da75-d34aad852bc4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-58": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|c4e94d44-bca7-2686-da75-d34aad852bd1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-60": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|c4e94d44-bca7-2686-da75-d34aad852bde",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-62": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|257f44fd-85e7-a436-6716-01e0bc6a9e96",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-64": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|257f44fd-85e7-a436-6716-01e0bc6a9ea2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-66": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|257f44fd-85e7-a436-6716-01e0bc6a9eaf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-68": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "652a7e71b05ba5609d4ec4a8|257f44fd-85e7-a436-6716-01e0bc6a9ebc",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-70": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "652a7e71b05ba5609d4ec4a8|f84095e4-4f1e-2e61-ffb0-f56b81484736",
      },
      targets: [],
      config: {
        loop: false,
    ...
    "e-72": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "652a7e71b05ba5609d4ec4a8|f84095e4-4f1e-2e61-ffb0-f56b81484738",
      },
      targets: [],
      config: {
        loop: false,
    ...
    "e-74": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|6dbb51e1-c79e-6e61-e144-35a2c94a8b3c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
    ...
    "e-76": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "651dadf80c43865b9bc87bc0|6dbb51e1-c79e-6e61-e144-35a2c94a8b55",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [],
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["0e46f078-fb67-9b75-2bab-797db90f41e9"],
                },
                xValue: -112,
                xUnit: "rem",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".image-9",
                  selectorGuids: ["b92bc017-f2d8-3ef2-1821-cb96474518cd"],
                },
                xValue: -50,
                xUnit: "px",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: ".certik-box",
                  selectorGuids: ["5fcfdf4e-a375-3be2-e5d3-c724e5023c3d"],
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".rl_menu-icon2_line-top-2",
                  selectorGuids: ["bf99d71b-68d6-5017-a762-b169a5710590"],
                },
                yValue: 8,
                xUnit: "PX",
                yUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".rl_menu-icon2_line-bottom-2",
                  selectorGuids: ["bf99d71b-68d6-5017-a762-b169a5710582"],
                },
                yValue: -8,
                xUnit: "PX",
                yUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".rl_menu-icon2_line-middle-2",
                  selectorGuids: ["bf99d71b-68d6-5017-a762-b169a5710589"],
                },
                value: 0,
                unit: "",
              },
    ...
    "a-43": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "bf99d71b-68d6-5017-a762-b169a571058e",
                    "bf99d71b-68d6-5017-a762-b169a5710591",
                  ],
                },
                value: "none",
              },
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1695839750038,
    },
    "a-51": {
      id: "a-51",
      title: "FAQ01 accordion -> OPEN",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "SIBLINGS",
                  selector: ".faq_answer",
                  selectorGuids: ["5975058b-84d4-1727-f2a9-5837dd9ee728"],
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["5975058b-84d4-1727-f2a9-5837dd9ee729"],
                },
                zValue: 90,
                xUnit: "DEG",
                yUnit: "DEG",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".arrow-left",
                  selectorGuids: ["83130cbb-6a3d-e7f9-c50e-63e0be76994e"],
                },
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".image-25",
                  selectorGuids: ["323589e7-feeb-2517-b70c-9817e29ed67c"],
                },
              },
            },
          ],
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["bd91d796-cd51-c917-2fcc-e37f5856f701"],
                },
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".image-26",
                  selectorGuids: ["3704db03-8519-cd4a-f15f-55f2f836f093"],
                },
              },
            },
          ],
